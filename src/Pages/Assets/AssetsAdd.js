...
const AssetsAdd = () => {
  ...
  const [addAssets, { data, error, loading }] = useMutation(
  ...
  if (error) {
    ...
    openNotificationWithIcon("addAssestError", "error", error.message);
  }
  ...
  return <AssetsForm handleAsset={handleAsset} loading={loading} />;
};
